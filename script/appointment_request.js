...
rootController.controller("MyCntrl", ['$scope', '$http', '$location', '$window', function ($scope, $http, $location, $window) {
    ...
    $scope.COMPANY_CODE = $scope.COMPANY_CODE == undefined || $scope.COMPANY_CODE== "" ? "" : $scope.COMPANY_CODE;
    $scope.DCR_ID = $scope.DCR_ID == undefined || $scope.DCR_ID== "" ? -1 : $scope.DCR_ID;
    $scope.DR_ID = $scope.DR_ID == undefined || $scope.DR_ID== "" ? -1 : $scope.DR_ID;
